...
export default function Home() {
  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-5 pb-16 pt-28 sm:px-8 sm:pt-32 lg:px-10">
      <section className="grid gap-6 rounded-3xl border border-border bg-card p-6 shadow-sm lg:grid-cols-[1.2fr_1fr] lg:p-8">
        <div className="flex flex-col justify-between gap-8">
          <div>
            ...
            <h1 className="mt-5 max-w-3xl text-4xl font-semibold leading-[1.05] tracking-tight text-foreground sm:text-5xl lg:text-6xl">
              Understand any codebase
              <span className="block text-muted-foreground">in minutes, not days.</span>
            </h1>
          ...
          <div className="flex flex-wrap items-center gap-3">
            {isLoggedIn && user ? (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground shadow-sm transition-colors hover:bg-accent"
              >
        ...
        <div className="grid gap-3">
          <div className="rounded-2xl border border-border bg-card p-4">
            <div className="flex items-center justify-between">
              <p className="font-repository text-sm text-muted-foreground">repo: acme/payment-service</p>
              <span className="rounded-full bg-emerald-500/10 px-2 py-1 text-xs text-emerald-600 dark:text-emerald-400">indexed</span>
            </div>
            <div className="mt-3 grid gap-2">
              <div className="rounded-lg bg-muted px-3 py-2 font-search-result text-xs text-muted-foreground">
          ...
          <div className="rounded-2xl border border-border bg-card p-4">
            <p className="mb-2 text-xs uppercase tracking-wide text-muted-foreground">Ask SourceLens</p>
            <p className="rounded-lg bg-foreground px-3 py-2 font-code-viewer text-sm text-background">
      ...
      <section className="mt-8 rounded-3xl border border-border bg-card p-6 shadow-sm lg:p-8">
            ...
            return (
              <article key={step.title} className="rounded-2xl border border-border bg-card p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-file-path text-xs text-muted-foreground">0{idx + 1}</span>
                </div>
      ...
      <section className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-2xl border border-border bg-card p-4">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Find intent, not just keyword matches.</p>
        </div>
        <div className="rounded-2xl border border-border bg-card p-4">
          <div className="flex items-center gap-2 text-foreground">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Grounded responses with code citations.</p>
        </div>
        <div className="rounded-2xl border border-border bg-card p-4">
          <div className="flex items-center gap-2 text-foreground">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Understand architecture across files and services.</p>
        </div>
        <div className="rounded-2xl border border-border bg-card p-4">
          <div className="flex items-center gap-2 text-foreground">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Optimized vector indexing for quick lookup.</p>
        </div>
      </section>

      <footer className="mt-8 rounded-3xl border border-border bg-card px-5 py-5 shadow-sm sm:px-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-ui text-sm text-muted-foreground">
            Built by <span className="font-semibold text-foreground">{creator.name}</span>
          </p>
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
