...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[#f7f8fb] pb-20 pt-28 sm:pt-32">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-20 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-zinc-300/30 blur-3xl" />
        <div className="absolute top-[28rem] -left-20 h-80 w-80 rounded-full bg-zinc-200/35 blur-3xl" />
        <div className="absolute top-[60rem] right-0 h-96 w-96 rounded-full bg-zinc-300/25 blur-3xl" />
      </div>

      <div className="relative mx-auto flex w-full max-w-7xl flex-col gap-8 px-5 sm:px-8 lg:px-10">
        <section className="grid items-stretch gap-4 rounded-3xl border border-white/70 bg-white/80 p-6 shadow-[0_20px_60px_rgba(24,24,27,0.08)] backdrop-blur-xl lg:grid-cols-[1.2fr_1fr] lg:p-8">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {isLoggedIn && user ? (
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-zinc-300 bg-white px-4 py-2 text-sm font-medium text-zinc-900 shadow-sm transition-all hover:-translate-y-0.5 hover:border-zinc-400 hover:bg-zinc-50"
                >
                ...
                <button
                  type="button"
                  onClick={handleLogin}
                  className="inline-flex items-center gap-2 rounded-full bg-zinc-900 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:-translate-y-0.5 hover:bg-black"
                >
        ...
        <section className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-[0_20px_60px_rgba(24,24,27,0.06)] backdrop-blur-xl lg:p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {howItWorksSteps.map((step, idx) => {
              ...
              return (
                <article
                  key={step.title}
                  className="group rounded-2xl border border-zinc-200/80 bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
                >
                  <div className="flex items-center justify-between">
        ...
        <footer className="mt-2 rounded-3xl border border-white/70 bg-white/85 px-5 py-5 shadow-[0_12px_35px_rgba(24,24,27,0.06)] backdrop-blur-xl sm:px-6">
